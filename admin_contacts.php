         ...
         if (mysqli_num_rows($select_message) > 0) {
            while ($fetch_message = mysqli_fetch_assoc($select_message)) {
               ...
               <div class="box">
                  ...
                  <p>Номер телефона: <span><?php echo $fetch_message['number']; ?></span> </p>
                  <p>Электронная почта: <span><?php echo $fetch_message['email']; ?></span> </p>
                  <p>Сообщение: <span><?php echo $fetch_message['message']; ?></span> </p>

                  <a href="admin_contacts.php?delete=<?php echo $fetch_message['id']; ?>"
                     onclick="return confirm('delete this message?');" class="delete-btn">Удалить</a>
               </div>
               <?php
            }
         } else {
